																																						...
																																						?><a href="javascript:void(0)" onclick="showPartnerForm(<? echo CUtil::PhpToJSObject($arParamsPartner) ?>); return false;" class="footer-link"><?= GetMessage("BITRIX24_PARTNER_CONNECT") ?></a><?
																																																																																					...
																																																																																					$orderParams = \CBitrix24::getPartnerOrderFormParams();
																																																																																						?><a class="b24-web-form-popup-btn-57 footer-link" onclick="B24.showPartnerOrderForm(<?= CUtil::PhpToJSObject($orderParams) ?>);"><?= GetMessage("BITRIX24_PARTNER_ORDER") ?></a><?
																																																																																																																																			...
																																																																																																																																			?><a href="javascript:void(0)" onclick="BX.Helper.show();" class="footer-link"><?= GetMessage("BITRIX24_MENU_CLOUDMAN") ?></a><?
																																																																																																																																																																		}

																																																																																																																																																																			?><span class="footer-link" onclick="BX.Intranet.Bitrix24.ThemePicker.Singleton.showDialog()"><?= GetMessage("BITRIX24_THEME") ?></span><?

																																																																																																																																																																																																					?><span class="footer-link" onclick="window.scroll(0, 0); setTimeout(function() {window.print()}, 0)"><?= GetMessage("BITRIX24_PRINT") ?></span><?
...
<div class="popup-wrapper">
	...
	<div class="popup accepted" data-type="accepted">
		...
		<img src="<?= SITE_TEMPLATE_PATH ?>/images/accepted.svg" alt="">
		<div class="popup__title">Обращение отправлено</div>
		<a href="/knowledgebase/" class="btn">На главную</a>
	</div>
</div>
