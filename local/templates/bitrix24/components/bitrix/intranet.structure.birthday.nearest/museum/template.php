...
?>
	...
	<script type="text/javascript">
		window.onload = function() {
			document.forms.bx_birthday_filter.department.onchange = function() {
				this.form.submit()
			}
		}
	</script>
...
<section class="birthdays">
	<div class="container">
		...
		<h1>Когда у коллег День Рождения </h1>

		<a href="" class="birthday__btn birthday btn" data-form="gift" data-recipient="<?= \Bitrix\Main\Config\Option::get("grain.customsettings", "RECIPIENT_GIFT") ?>">Внести хотелку на День Рождения</a>
