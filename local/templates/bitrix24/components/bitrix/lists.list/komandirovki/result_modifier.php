...
// Удаление из фильтров, заголовков и непосредственно массивов информации о сотруднике

unset($cp->arResult['ELEMENTS_HEADERS'][8]); //[8]
unset($cp->arResult['FILTER'][9]); //[9]
foreach ($arResult['ELEMENTS_ROWS'] as $key => $value) {
    unset($cp->arResult['ELEMENTS_ROWS'][$key]['columns']['PROPERTY_293']);
}
?>
