...
const journalItem = document.querySelector('.menu-item-no-icon-state[data-link="/services/lists/?mode=edit&list_id=64&section_id=0&element_id=0&list_section_id="');
										   console.log(journalItem);
if (window.location.href.includes("services/lists/") || window.location.href.includes("services/lists/") || window.location.href.includes("komandirovki") || window.location.href.includes("company/personal/bizproc/") || window.location.href.includes("komandirovki/history") || window.location.href.includes("services/lists/")) {
journalItem.classList.add('menu-item-active')
};})()
