	...
	var Widget = /*#__PURE__*/function (_EventEmitter) {
		...
		function Widget(container, _ref) {
			...
			var _ref$profile = _ref.profile,
				...
				IS_ADMIN = _ref$profile.IS_ADMIN,
		...
		babelHelpers.createClass(Widget, [{
			...
			value: function getPopup() {
				var _classPrivateMethodGe, _classPrivateMethodGe2, tempArray = {}, tempArray2 = {}, tempArray3 = {};
				if (babelHelpers.classPrivateFieldGet(this, _popup)) {
					return babelHelpers.classPrivateFieldGet(this, _popup);
				}

				if (babelHelpers.classPrivateFieldGet(this, _profile).IS_ADMIN) {
					tempArray = {
				...
				var content = [
					_classPrivateMethodGet$2(this, _getProfileContainer, _getProfileContainer2)
						.call(this),
					_classPrivateMethodGet$2(this, _getb24NetPanelContainer, _getb24NetPanelContainer2)
						.call(this) ?
						{
							html: _classPrivateMethodGet$2(this, _getb24NetPanelContainer, _getb24NetPanelContainer2).call(this),
							backgroundColor: '#fafafa'
						} : null,
					_classPrivateMethodGet$2(this, _getAdminPanelContainer, _getAdminPanelContainer2)
						.call(this) ?
						{
					...
					_classPrivateMethodGet$2(this, _getCompanyPulse, _getCompanyPulse2)
						.call(this, !!_classPrivateMethodGet$2(this, _getStressLevel, _getStressLevel2)
							.call(this)) ?
						[{
						...
						}, _classPrivateMethodGet$2(this, _getStressLevel, _getStressLevel2).call(this)]
						: null,
					_classPrivateMethodGet$2(this, _getOTPContainer, _getOTPContainer2)
						.call(this, _classPrivateMethodGet$2(this, _getDeskTopContainer, _getDeskTopContainer2).call(this) === null) &&
						_classPrivateMethodGet$2(this, _getDeskTopContainer, _getDeskTopContainer2).call(this) ?
						[
							{
								flex: 0.5,
							...
							[
								...
								_classPrivateMethodGet$2(this, _getOTPContainer, _getOTPContainer2).call(this)
							]
						]
						:
						_classPrivateMethodGet$2(this, _getDeskTopContainer, _getDeskTopContainer2).call(this) ||
							...
							[
								...
								(_classPrivateMethodGe = _classPrivateMethodGet$2(this, _getDeskTopContainer, _getDeskTopContainer2).call(this)) !== null &&
									_classPrivateMethodGe !== void 0 ? _classPrivateMethodGe : _classPrivateMethodGet$2(this, _getOTPContainer, _getOTPContainer2).call(this)
							] :
							_classPrivateMethodGet$2(this, _getQrContainer, _getQrContainer2)
								.call(this, 0),
					_classPrivateMethodGet$2(this, _getLoginHistoryContainer, _getLoginHistoryContainer2)
						.call(this),
					tempArray3,
					[
						{
...
function hideProfileElements() {
	let themes = $('.ui-popupcomponentmaker__content--section-item [title="Тема оформления"]').parent().parent();
	let mob = $('.system-auth-form__qr').parent().parent().parent().parent();
	let objExt = $('.system-auth-form__item-title');
	for (i=0;i<objExt.length;i++) {
		if (objExt[i].innerText == 'Расширения') {
			objExt[i].parentNode.parentNode.parentNode.parentNode.style.display = 'none';
		}
	}
	if (themes.length > 0) {
		themes.hide();
...
setTimeout(hideProfileElements, 150);