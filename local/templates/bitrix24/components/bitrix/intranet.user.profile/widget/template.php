...
<script type='application/javascript'>
		...
		BX.Intranet.UserProfile.Widget.init(
			...
			<?= \CUtil::PhpToJSObject([
				...
				'profile' => [
					...
					'STATUS' => ((!empty($arResult['User']['STATUS'])
				...
				'features' => [
					...
					'stressLevel' => Main\Config\Option::get('intranet', 'stresslevel_available', 'Y') === 'Y' && (!$bitrix24Included || \Bitrix\Bitrix24\Release::isAvailable('stresslevel')
    ...
    document.onload = function (){
        $('.ui-popupcomponentmaker__content--section-item [title="Тема оформления"]').parent().hide();
    }
</script>
<?php
