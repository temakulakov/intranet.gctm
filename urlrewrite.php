...
$arUrlRewrite=array (
  ...
  155 => 
  array (
    'CONDITION' => '#^/knowledgebase/gallery/([a-zA-Z0-9_-]+)/?(.*)#',
    'RULE' => 'ELEMENT_CODE=$1',
    'ID' => 'bitrix:news.detail',
    'PATH' => '/knowledgebase/gallery/detail.php',
    'SORT' => 100,
  ),
  157 => 
  array (
  ...
  159 => 
  array (
    'CONDITION' => '#^/knowledgebase/rules/([a-zA-Z0-9_-]+)/?(.*)#',
    'RULE' => 'ELEMENT_CODE=$1',
    'ID' => 'bitrix:news.detail',
    'PATH' => '/knowledgebase/rules/detail.php',
    'SORT' => 100,
  ),
  152 => 
  array (
    'CONDITION' => '#^/knowledgebase/guide/([a-zA-Z0-9_-]+)/?(.*)#',
    'RULE' => 'ELEMENT_CODE=$1',
    'ID' => 'bitrix:news.detail',
    'PATH' => '/knowledgebase/guide/detail.php',
    'SORT' => 100,
  ),
  18 => 
  array (
  ...
  163 => 
  array (
    'CONDITION' => '#^/knowledgebase/department-information/#',
    'RULE' => '',
    'ID' => 'bitrix:news',
    'PATH' => '/knowledgebase/department-information/index.php',
    'SORT' => 100,
  ),
  11 => 
  array (
  ...
  158 => 
  array (
    'CONDITION' => '#^/knowledgebase/news/#',
    'RULE' => '',
    'ID' => 'bitrix:news',
    'PATH' => '/knowledgebase/news/index.php',
    'SORT' => 100,
  ),
  42 => 
  array (
